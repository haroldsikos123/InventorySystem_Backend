-- ================================================================================
-- SCRIPT DE SIMULACIÓN COMPLETA DE ATENCIÓN DE TICKETS (PostgreSQL Compatible)
...
-- ================================================================================
-- INSTRUCCIONES:
-- 1. Asegúrate de tener una UNIQUE constraint en rol.rol
-- 2. Ajusta el @empresa_id si tu empresa tiene un ID diferente
-- 3. Ejecuta este script en bloques según se indica
-- ================================================================================
...
-- Agregar constraint UNIQUE si no existe (ejecutar solo una vez)
...
-- ================================================================================
-- PASO 2: CREAR O ACTUALIZAR USUARIOS CON DO BLOCK
-- ================================================================================
...
DECLARE
    ...
    v_empresa_id INTEGER := 1; -- AJUSTAR ESTE VALOR SEGÚN TU BD
...
BEGIN
    ...
    VALUES ('edwin.perez', '$2a$10$YourHashedPasswordHere1', 'Edwin', 'Perez', 
            'edwin.perez@company.com', 987654321, TRUE, v_rol_user, v_empresa_id)
    ...
    INSERT INTO usuario (username, password, nombre, apellido, correo, telefono, enabled, rol_id, empresa_id)
    VALUES ('fabiola.perez', '$2a$10$YourHashedPasswordHere2', 'Fabiola', 'Perez',
            'fabiola.perez@company.com', 987654322, TRUE, v_rol_user, v_empresa_id)
    ON CONFLICT (username) DO UPDATE SET
        nombre = 'Fabiola',
        apellido = 'Perez',
        rol_id = v_rol_user
    ...
    INSERT INTO usuario (username, password, nombre, apellido, correo, telefono, enabled, rol_id, empresa_id)
    VALUES ('juan.camacho', '$2a$10$YourHashedPasswordHere3', 'Juan', 'Camacho',
            'juan.camacho@company.com', 987654323, TRUE, v_rol_guest, v_empresa_id)
    ON CONFLICT (username) DO UPDATE SET
        nombre = 'Juan',
        apellido = 'Camacho',
        rol_id = v_rol_guest
    ...
    INSERT INTO usuario (username, password, nombre, apellido, correo, telefono, enabled, rol_id, empresa_id)
    VALUES ('frederick.ayala', '$2a$10$YourHashedPasswordHere4', 'Frederick Ayala', 'Perez',
            'frederick.ayala@company.com', 987654324, TRUE, v_rol_soporte_n1, v_empresa_id)
    ON CONFLICT (username) DO UPDATE SET
    ...
    INSERT INTO usuario (username, password, nombre, apellido, correo, telefono, enabled, rol_id, empresa_id)
    VALUES ('jhon.sikos', '$2a$10$YourHashedPasswordHere5', 'Jhon Harold Sikos', 'Astete',
            'jhon.sikos@company.com', 987654325, TRUE, v_rol_soporte_n2, v_empresa_id)
    ON CONFLICT (username) DO UPDATE SET

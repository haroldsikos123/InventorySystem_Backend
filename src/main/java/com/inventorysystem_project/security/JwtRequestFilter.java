...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        // 🔹 DEBUG: Imprimir detalles del token y username
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            // 🔹 DEBUG: Imprimir detalles del usuario y sus roles
            System.out.println("UserDetails loaded: " + userDetails.getUsername());
            System.out.println("Authorities: " + userDetails.getAuthorities());
            System.out.println("Token valid? " + jwtTokenUtil.validateToken(jwtToken, userDetails));
            ...
            if (jwtTokenUtil.validateToken(jwtToken, userDetails)) {
                ...
                // 🔹 DEBUG: Confirmar que se ha seteado la autenticación
